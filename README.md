...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/604079d2101bff0015d76ca9
...
To start editing your site, you can use the Sanity interface at https://oval-neptune-079d2.sanity.studio/.
...
Generated at `2021-03-04T06:11:23.233Z` by Stackbit version `0.3.50`.